...
def is_peace_sign(hand_landmarks):
    ...
    cond = 150 * index_finger_tip.z * 3

    return (index_to_ring > cond and
            index_to_pinky > cond and
            wrist_to_ring < cond and
            wrist_to_pinky < cond and
            wrist_to_middle > cond and
