...
def identify_outermost_inner_and_cell_centers(grid_intersections):
    ...
    while True:
        ...
        try:
            ...
            if structured_grid is not None:
                ...
                # Draw pink lines connecting intersections (grid structure)
                ...
                # Identify intersections and cell centers
                outermost_intersections, inner_intersections, corner_intersections, cell_centers = identify_outermost_inner_and_cell_centers(structured_grid)
