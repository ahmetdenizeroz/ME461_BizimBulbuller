...
if not cap.isOpened():
    ...
    while True:
        ...
        if len(structured_grid) > 0:
            ...
            # Draw boundary lines connecting only the corner points
            if len(corner_intersections) == 4:
                # Connect top-left to top-right
                cv2.line(intersection_image, corner_intersections[0], corner_intersections[1], (0, 165, 255), 2)
                # Connect bottom-left to bottom-right
                cv2.line(intersection_image, corner_intersections[2], corner_intersections[3], (0, 165, 255), 2)
                # Connect top-left to bottom-left
                cv2.line(intersection_image, corner_intersections[0], corner_intersections[2], (0, 165, 255), 2)
                # Connect top-right to bottom-right
                cv2.line(intersection_image, corner_intersections[1], corner_intersections[3], (0, 165, 255), 2)
            ...
            cv2.imshow("Detected Intersections & Grid Boundaries", intersection_image)
